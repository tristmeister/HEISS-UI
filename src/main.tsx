...
function App() {
  ...
  const { upscaleStatus, upscaleUnavailableReason, upscaleSetup, upscaleInstall, upscaleBusyIds, refreshUpscaleStatus, cancelUpscaleInstall, activateUpscale, toggleUpscale } = useUpscale({
    prefs,
    showToast,
    loadGalleryDelta
  });
