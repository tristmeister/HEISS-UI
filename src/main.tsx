...
function App() {
  ...
  const { generate, cancelJob, cancelQueue, clearGallery, clearFailedItems, resetAllSettings, clearAllCache, restartComfy, openOutputFolder, deleteItem } = generationActions;
