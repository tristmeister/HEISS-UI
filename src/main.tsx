...
function App() {
  ...
  const { upscaleStatus, upscaleUnavailableReason, upscaleSetup, upscaleInstall, upscaleBusyIds, upscaleNotices, dismissUpscaleNotice, refreshUpscaleStatus, cancelUpscaleInstall, activateUpscale, toggleUpscale } = useUpscale({
    prefs,
    showToast,
    loadGalleryDelta
  });
